...
public class SM04SvcImpl implements SM04Svc {
	...
	public int grid1_selectCount(Map<String, String> paramMap) {
		return sm04Mapper.grid1_selectCount(paramMap);
	}

	// 그리드 리스트
	@Override
	public List<Map<String, String>> grid1_selectList(Map<String, String> paramMap) {
		return sm04Mapper.grid1_selectList(paramMap);
	}
	...
	public List<Map<String, String>> select_stock_modal(Map<String, String> paramMap) {
		return sm04Mapper.select_stock_modal(paramMap);
	}
	
	// 수정화면 정보
	@Override
	public Map<String, String> select_sm04_Info(Map<String, String> paramMap) {
		return sm04Mapper.select_sm04_Info(paramMap);
	}
	
	// 수정화면 상세정보
	@Override
	public List<Map<String, String>> select_sm04_Info_Dtl(Map<String, String> paramMap) {
		return sm04Mapper.select_sm04_Info_Dtl(paramMap);
	}
	...
	public int insert_sm04(Map<String, String> paramMap, MultipartHttpServletRequest mRequest) throws Exception {
		...
		String newMNGM_NO = sm04Mapper.select_sm04_Next_MNGM_NO(paramMap);
	    ...
	    for (Map<String, String> dtl : dtlParam) {
	    	...
	    	if ("I".equals(dataChk)) {
				...
				//데이터 처리
				sm04Mapper.insert_sm04_Dtl(dtl);
				i++;
	    	}
	    }
		//데이터 처리 끝
	...
	//DATA UPDATE
	@Override
	public int update_sm04(Map<String, String> paramMap, MultipartHttpServletRequest mRequest) throws Exception {
		//Gson gson = new Gson();
		Gson gsonDtl = new GsonBuilder().disableHtmlEscaping().create();
		Type dtlMap = new TypeToken<ArrayList<Map<String, String>>>(){}.getType();
		...
		//데이터처리 시작
		//마스터 수정
		int result = sm04Mapper.update_sm04(paramMap);
	...
	//DATA DELETE
	@Override
	public int delete_sm04(Map<String, String> paramMap) throws Exception {
		//---------------------------------------------------------------
		...
		if ("1".equals(lvl)) {
    		...
    		result = sm04Mapper.delete_sm04_Dtl(paramMap);
    	}
		
		//int result = sm04Mapper.delete_sm04(paramMap);
