...
public class SM30SvcImpl implements SM30Svc {
    ...
    public Map<String, Object> insertBomDetailList(Map<String, String> param) {
        ...
        return sm30Mapper.insertBomDetailList(param);
    }

    @Override
    public int deleteBom(Map<String, String> paramMap) {
        int result = sm30Mapper.deleteBom(paramMap);
        result += sm30Mapper.deleteAllBomDetails(paramMap);
        return result;
    }

    @Override
    public Map<String, Object> selectBomInfo(Map<String, String> param) {
        return sm30Mapper.selectBomInfo(param);
    }

    @Override
    public List<Map<String, Object>> selectBomListMatr(Map<String, String> param) {
        return sm30Mapper.selectBomListMatr(param);
    }
...
/*
        ...
        List<Map<String, Object>> dbDetailListRaw = sm30Mapper.selectBomList(paramMap);
        ...
        for (Map<String, Object> estDetail : detailList) {
            ...
            for (Map<String, String> estDetail : detailList) {
                sm30Mapper.updateBom(estDetail);
            }
