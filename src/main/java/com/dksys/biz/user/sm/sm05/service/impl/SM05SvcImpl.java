...
public class SM05SvcImpl implements SM05Svc {
	...
	@Override
	public int selectIoCount(Map<String, String> paramMap) {
		return sm05Mapper.selectIoCount(paramMap);
	}

	@Override
	public List<Map<String, String>> selectIoList(Map<String, String> paramMap) {
...
//	}
	...
	// 수정화면 정보
	@Override
	public Map<String, String> selectIoInfo(Map<String, String> paramMap) {
		return sm05Mapper.selectIoInfo(paramMap);
	}
...
//		// ---------------------------------------------------------------
//
//		int result = sm05Mapper.updatePchsCost(paramMap);
//
//		// ---------------------------------------------------------------
//		// 첨부 화일 처리 시작
//		// ---------------------------------------------------------------
...
//		// ---------------------------------------------------------------
//
//		int fileTrgtKey = sm05Mapper.selectPchsCostSeqNext(paramMap);
//		paramMap.put("fileTrgtKey", Integer.toString(fileTrgtKey));
//
//		int result = sm05Mapper.insertPchsCost(paramMap);
//
//		// ---------------------------------------------------------------
