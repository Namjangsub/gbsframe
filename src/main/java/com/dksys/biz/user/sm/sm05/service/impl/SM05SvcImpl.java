...
public class SM05SvcImpl implements SM05Svc {
	...
	@Override
	public int selectPchsCount(Map<String, String> paramMap) {
		return sm05Mapper.selectPchsCount(paramMap);
	}

	@Override
	public List<Map<String, String>> selectPchsList(Map<String, String> paramMap) {
		return sm05Mapper.selectPchsList(paramMap);
	}
	...
	public Map<String, String> selectPchsCostInfo(Map<String, String> paramMap) {
		return sm05Mapper.selectPchsCostInfo(paramMap);
	}
