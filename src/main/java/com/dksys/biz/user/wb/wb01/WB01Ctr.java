...
public class WB01Ctr {
	 ...
	 * {
	 * 
	 * int totalCnt = wb01Svc.selectWbsPlanCount(paramMap); PaginationInfo
	 ...
	 * //<!-- WBS 일정계획 등록 메인 화면 조회 리스트 -->
	 * 
	 * @PostMapping(value = "/selectWbsPlanExcelList") public String
	 * selectWbsPlanExcelList(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> resultList =
	 * wb01Svc.selectWbsPlanExcelList(paramMap); model.addAttribute("resultList",
	 * resultList); return "jsonView";
	 * 
	 * }
	 */
	  ...
	  selectWbsPlanNoList(@RequestBody Map<String, String> paramMap, ModelMap
	  model) {
	  
	  List<Map<String, String>> codeInfoList =
	  wb01Svc.selectWbsPlanNoList(paramMap); model.addAttribute("codeInfoList",
	  codeInfoList); return "jsonView";
	  ...
	  selectWbsSalesCodeList(@RequestBody Map<String, String> paramMap, ModelMap
	  model) {
	  
	  List<Map<String, String>> codeInfoList =
	  wb01Svc.selectWbsSalesCodeList(paramMap); model.addAttribute("codeInfoList",
	  codeInfoList); return "jsonView";
	...
	/*
	 * @PostMapping(value = "/selectWbsPlanDivList") public String
	 * selectWbsPlanDivList(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> codeInfoList =
	 * wb01Svc.selectWbsPlanDivList(paramMap); model.addAttribute("codeInfoList",
	 * codeInfoList); return "jsonView";
	 * 
	 * }
	 */
	 ...
	 * 
	 * @PostMapping(value = "/selectWbsLevel1List") public String
	 * selectWbsLevel1List(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> codeInfoList =
	 * wb01Svc.selectWbsLevel1List(paramMap); model.addAttribute("codeInfoList",
	 * codeInfoList); return "jsonView";
	 * 
	 * }
	 */
	 ...
	 * //<!-- 설계난이도 Combobox 처리 -->
	 * 
	 * @PostMapping(value = "/selectWbsDsgnDifList") public String
	 * selectWbsDsgnDifList(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> codeInfoList =
	 * wb01Svc.selectWbsDsgnDifList(paramMap); model.addAttribute("codeInfoList",
	 * codeInfoList); return "jsonView";
	 * 
	 * }
	 */
	 ...
	 * //<!-- 생산난이도 Combobox 처리 -->
	 * 
	 * @PostMapping(value = "/selectWbsPrdctnDifList") public String
	 * selectWbsPrdctnDifList(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> codeInfoList =
	 * wb01Svc.selectWbsPrdctnDifList(paramMap); model.addAttribute("codeInfoList",
	 * codeInfoList); return "jsonView";
	 * 
	 * }
	 */
	 ...
	 * 
	 * @PostMapping(value = "/selectWbsLevel2List") public String
	 * selectWbsLevel2List(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> codeInfoList =
	 * wb01Svc.selectWbsLevel2List(paramMap); model.addAttribute("codeInfoList",
	 * codeInfoList); return "jsonView"; }
	 */
	 ...
	 * 
	 * @PostMapping(value = "/selectWbsLevel3List") public String
	 * selectWbsLevel3List(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> codeInfoList =
	 * wb01Svc.selectWbsLevel3List(paramMap); model.addAttribute("codeInfoList",
	 * codeInfoList); return "jsonView";
	 * 
	 * }
	 */
	...
	/*
	 * @PostMapping(value = "/selectWbsPlanStsList") public String
	 * selectWbsPlanStsList(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> codeInfoList =
	 * wb01Svc.selectWbsPlanStsList(paramMap); model.addAttribute("codeInfoList",
	 * codeInfoList); return "jsonView";
	 * 
	 * }
	 */
	 ...
	 * 
	 * @PostMapping(value = "/selectWbsPopupLevel2PlanList") public String
	 * selectWbsPopupLevel2PlanList(@RequestBody Map<String, String> paramMap,
	 * ModelMap model) {
	 * 
	 * List<Map<String, String>> resultList =
	 * wb01Svc.selectWbsPopupLevel2PlanList(paramMap);
	 * model.addAttribute("resultList", resultList); return "jsonView";
	 * 
	 * }
	 * 
	 ...
	 * 
	 * @PostMapping(value = "/selectWbsPopupLevel3PlanList") public String
	 * selectWbsPopupLevel3PlanList(@RequestBody Map<String, String> paramMap,
	 * ModelMap model) {
	 * 
	 * List<Map<String, String>> resultList =
	 * wb01Svc.selectWbsPopupLevel3PlanList(paramMap);
	 * model.addAttribute("resultList", resultList); return "jsonView";
	 * 
	 * }
	 */
	  ...
	  //<!-- WBS 공유대상자 조회 리스트 처리 -->  
	/*
	 * @PostMapping(value = "/selectWbsPopupSharngList") public String
	 * selectWbsPopupSharngList(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) {
	 * 
	 * List<Map<String, String>> resultList =
	 * wb01Svc.selectWbsPopupSharngList(paramMap); model.addAttribute("resultList",
	 * resultList); return "jsonView";
	 * 
	 * }
	 */
	 ...
	 * //<!-- WBS 공유대상자 삭제 처리 -->
	 * 
	 * @DeleteMapping(value = "/deleteWbsSharngUser") public String
	 * deleteWbsSharngUser(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) { wb01Svc.deleteWbsSharngUser(paramMap);
	 * model.addAttribute("resultCode", 200); model.addAttribute("resultMessage",
	 * messageUtils.getMessage("delete")); return "jsonView"; }
	 */
	...
	/*
	 * @PostMapping(value = "/insertWbsSharngUser") public String
	 * insertWbsSharngUser(@RequestParam Map<String, String> paramMap,
	 * MultipartHttpServletRequest mRequest, ModelMap model) {
	 * wb01Svc.insertWbsSharngUser(paramMap); wb01Svc.insertToDoList(paramMap);
	 * //model.addAttribute("shipSeq", paramMap.get("shipSeq"));
	 * model.addAttribute("resultCode", 200); model.addAttribute("resultMessage",
	 * messageUtils.getMessage("insert")); return "jsonView"; }
	 */
	  
	/*
	 * @PostMapping(value = "/wbsLevel1PlanInsert") public String
	 * wbsLevel1PlanInsert(@RequestParam Map<String, String> paramMap,
	 * MultipartHttpServletRequest mRequest, ModelMap model) { List<Map<String,
	 * String>> sharngChk = wb01Svc.deleteWbsSharngListChk(paramMap); if
	 * (sharngChk.size() > 0) { wb01Svc.deleteWbsSharngList(paramMap); }
	...
	/*
	 * @PutMapping(value = "/wbsLevel1PlanUpdate") public String
	 * wbsLevel1PlanUpdate(@RequestParam Map<String, String> paramMap,
	 * MultipartHttpServletRequest mRequest, ModelMap model) { List<Map<String,
	 * String>> sharngChk = wb01Svc.deleteWbsSharngListChk(paramMap); if
	 * (sharngChk.size() > 0) { wb01Svc.deleteWbsSharngList(paramMap); }
	 ...
	 * 
	 * @PostMapping(value = "/selectWbsInfoList") public String
	 * selectWbsInfoList(@RequestBody Map<String, String> paramMap, ModelMap model)
	 * { List<Map<String, String>> resultList = wb01Svc.selectWbsInfoList(paramMap);
	 * model.addAttribute("resultList", resultList); return "jsonView"; }
	 */
	  
	/*
	 * @PostMapping(value = "/wbsLevel2PlanInsert") public String
	 * wbsLevel2PlanInsert(@RequestParam Map<String, String> paramMap,
	 * MultipartHttpServletRequest mRequest, ModelMap model) { List<Map<String,
	 * String>> sharngChk = wb01Svc.deleteWbsSharngListChk(paramMap); if
	 * (sharngChk.size() > 0) { wb01Svc.deleteWbsSharngList(paramMap); }
	...
	/*
	 * @PutMapping(value = "/wbsLevel2PlanUpdate") public String
	 * wbsLevel2PlanUpdate(@RequestParam Map<String, String> paramMap,
	 * MultipartHttpServletRequest mRequest, ModelMap model) { List<Map<String,
	 * String>> sharngChk = wb01Svc.deleteWbsSharngListChk(paramMap); if
	 * (sharngChk.size() > 0) { wb01Svc.deleteWbsSharngList(paramMap); }
	...
	/*
	 * @PostMapping(value = "/wbsLevel3PlanInsert") public String
	 * wbsLevel3PlanInsert(@RequestParam Map<String, String> paramMap,
	 * MultipartHttpServletRequest mRequest, ModelMap model) { List<Map<String,
	 * String>> sharngChk = wb01Svc.deleteWbsSharngListChk(paramMap); if
	 * (sharngChk.size() > 0) { wb01Svc.deleteWbsSharngList(paramMap); }
	 ...
	 * messageUtils.getMessage("insert")); return "jsonView"; }
	 * 
	 * @PutMapping(value = "/wbsLevel3PlanUpdate") public String
	 * wbsLevel3PlanUpdate(@RequestParam Map<String, String> paramMap,
	 * MultipartHttpServletRequest mRequest, ModelMap model) { List<Map<String,
	 * String>> sharngChk = wb01Svc.deleteWbsSharngListChk(paramMap); if
	 * (sharngChk.size() > 0) { wb01Svc.deleteWbsSharngList(paramMap); }
	...
	/*
	 * //<!-- TO-DO 리스트에서 넘겨받은 조건에 따른 WBS PLAN 정보 조회 --> //<!-- WBS 1,2Level 정보 조회
	 * 리스트 -->
	 * 
	 * @PostMapping(value = "/selectWbsPlanInfoSelect") public String
	 * selectWbsPlanInfoSelect(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) { List<Map<String, String>> resultList =
	 * wb01Svc.selectWbsPlanInfoSelect(paramMap); model.addAttribute("resultList",
	 * resultList); return "jsonView"; }
	 */
	/*
	 * //<!-- /* WBS 상위레벨 데이터 체크
	...
	/*
	 * @PostMapping(value = "/selectFileCodeSelect") public String
	 * selectFileCodeSelect(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) { List<Map<String, String>> result =
	 * wb01Svc.selectFileCodeSelect(paramMap); model.addAttribute("result", result);
	 * return "jsonView"; }
	 */
	  ...
	  //<!-- 실적 마스터 테이블 조회  --> 
	/*
	 * @PostMapping(value = "/selectWbsRsltsMasterList") public String
	 * selectWbsRsltsMasterList(@RequestBody Map<String, String> paramMap, ModelMap
	 * model) { Map<String, String> resultList =
	 * wb02Svc.selectWbsRsltsMasterList(paramMap); model.addAttribute("resultList",
	 * resultList); return "jsonView";
	 * 
	 * }
	 */
