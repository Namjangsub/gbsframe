package com.dksys.biz.user.wb.wb06;
...
public class WB06Ctr {
	
	private Logger logger = LoggerFactory.getLogger(WB06Ctr.class);
    ...
    //<!-- WBS 결재선관리 메인 화면 조회 리스트  -->
	  ...
	  public String selectApplovalList(@RequestBody Map<String, String> paramMap, ModelMap model) {
		  ...
		  int totalCnt = wb06Svc.selectApprovalListCount(paramMap); 
		  PaginationInfo paginationInfo = new PaginationInfo(paramMap, totalCnt);
		  model.addAttribute("paginationInfo", paginationInfo);
		  
  		  List<Map<String, String>> resultList = wb06Svc.selectApprovalList(paramMap);
