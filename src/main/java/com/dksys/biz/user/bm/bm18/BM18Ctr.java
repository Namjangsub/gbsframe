...
public class BM18Ctr {
    ...
    // 알림톡 Completed MESSAGE ID
    @PostMapping(value = "/selectMaxMessageIdTodoCompleted")
    public String selectMaxMessageIdTodoCompleted(@RequestBody Map<String, String> paramMap, ModelMap model) {
        List<Map<String, String>> resultList = bm18Svc.selectMaxMessageIdTodoCompleted(paramMap);
        model.addAttribute("resultList", resultList);
        return "jsonView";
    }
