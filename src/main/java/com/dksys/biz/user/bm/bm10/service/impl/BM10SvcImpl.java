...
public class BM10SvcImpl implements BM10Svc {
	...
	public int update_bm10(Map<String, String> paramMap, MultipartHttpServletRequest mRequest) throws Exception {
		...
		int result = bm10Mapper.update_bm10(paramMap);
	...
	public int insert_bm10(Map<String, String> paramMap, MultipartHttpServletRequest mRequest) throws Exception {
		...
		int fileTrgtKey = bm10Mapper.select_bm10_SeqNext(paramMap);
		paramMap.put("fileTrgtKey", Integer.toString(fileTrgtKey));
		
		int result = bm10Mapper.insert_bm10(paramMap);
		//---------------------------------------------------------------
	...
	public int delete_bm10(Map<String, String> paramMap) throws Exception {
		...
		int result = bm10Mapper.delete_bm10(paramMap);
		//---------------------------------------------------------------
		//첨부 화일 처리 시작  (처음 등록시에는 화일 삭제할게 없음)
		//---------------------------------------------------------------
		if (deleteFileList.size() > 0) {
