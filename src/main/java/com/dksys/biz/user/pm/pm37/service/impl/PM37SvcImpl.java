package com.dksys.biz.user.pm.pm37.service.impl;
...
import com.dksys.biz.user.pm.pm37.mapper.PM37Mapper;
...
public class PM37SvcImpl implements PM37Svc{
	  @Autowired
	  PM37Mapper pm37Mapper;
	  
	  @Override
	  public int selectDailyWorkCount(Map<String, String> paramMap) {
	    return pm37Mapper.selectDailyWorkCount(paramMap);
	  }
	...
	@Override
	  public List<Map<String, String>> selectDailyWorkMainList(Map<String, String> paramMap) {
	    ...
	    return pm37Mapper.selectDailyWorkMainList(map);
	  }
