...
public interface CR05Mapper {
    ...
    // 관리번호 생성
    String select_cr05_Next_MNGM_NO(Map<String, String> paramMap);
	...
	int update_cr05_Conf(Map<String, String> paramMap);

	int update_cr05_Del(Map<String, String> paramMap);
