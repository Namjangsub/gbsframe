...
//			const response = await fetch(`/admin/cm/cm08/fileDownloadAuth?fileKey=${fileKey}&userId=${jwt.userId}&coCd=${coCd}`);
		...
		fileListArea.append(`
			...
			<div id="fileAttachCnts" style="display:none">
				<div class="contents mg0 pd0" style="width: 100%; min-width: 200px">
					<h3 class="location"><span class="page_tit" style="text-align: left;"> 파일트리</span></h3>
					<div id="treeview" style="height: 300px; padding: 5px;overflow-x: auto;">
						<div id="${selector}"></div>
					</div>
				</div>
	...
	function fromWebToApp(select, fileTrgtKey = "112233", rptPosition = 0, fileChoice) {
